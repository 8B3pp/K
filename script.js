...
function _uruchomInterfejs() {
    ...
    function renderujPolaFormularza() {
        ...
        if (t === 'informacja') {
            kontenerPol.innerHTML = `<div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Temat</label><input type="text" id="form-temat" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div><div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Treść</label><textarea id="form-szczegoly" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;height:80px;color:white;"></textarea></div>${priorytetSelect}<div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Data</label><input type="date" id="form-data" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div>`;
        } else {
            const et = t === 'sprawdzian' ? 'Jaki dział' : 'Jaki temat/dział';
            kontenerPol.innerHTML = `<div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Przedmiot</label><input type="text" id="form-temat" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div><div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">${et}</label><input type="text" id="form-szczegoly" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;color:white;"></div>${priorytetSelect}<div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Dodatkowe info</label><textarea id="form-dodatkowe" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;height:60px;"></textarea></div><div style="margin-bottom:15px;"><label style="display:block;margin-bottom:5px;font-size:14px;color:white;">Kiedy</label><input type="date" id="form-data" style="width:100%;padding:10px;border:2px solid #e2e8f0;border-radius:8px;"></div>`;
        }
    }
